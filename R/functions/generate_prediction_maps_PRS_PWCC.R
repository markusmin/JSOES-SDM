...
generate_prediction_maps <- function(report, obj, opt, model_name){
  ...
  ggsave(here::here("two_stage_models", "SDM_stage1", "PRS_PWCC", "figures", paste0(model_name, "_density_predict_map.png")), density_predict_map,  
         height = 8, width = 12)
  ...
  ggsave(here::here("two_stage_models", "SDM_stage1", "PRS_PWCC", "figures",  paste0(model_name, "_density_SE_predict_map.png")), SE_density_predict_map,  
         height = 8, width = 12)
