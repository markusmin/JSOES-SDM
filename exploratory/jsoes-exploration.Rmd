...
# A_gs = fm_evaluator(csyis_mesh, loc=st_coordinates(st_centroid(survey_grid_df)))$proj$A

pred.spatial = predict(spatial_fit_csyis, newdata = st_centroid(survey_grid_df), return_tmb_object = FALSE)
pred.spatial = predict(spatial_fit_csyis, newdata = data.frame(X = seq(-126, -123, 0.1), Y = seq(44, 47, 0.1)), return_tmb_object = FALSE)
