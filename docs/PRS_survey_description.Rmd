...
Since 2011, the PRS has been operated by the NWFSC and coordinates directly with the RREAS. The area covered by the PRS includes the Oregon and Washington coasts from approximately Brookings, OR to the mouth of the Columbia River. Sampling typically occurs between late May and early July, which overlaps considerably with the JSOES.
...
- Cephalopods (e.g., black-tip squid *Abraliopsis felis* and clawed armhook squid *Gonatus onyx*)
- Various teleost fishes, including:
  - Mesopelagic lanternfish species (e.g., *Stenobrachius leucopsarus* and *Tarletonbeania crenularis*)
