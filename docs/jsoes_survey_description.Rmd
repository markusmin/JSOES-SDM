...
- Euphausiids
- Copepods
- Various invertebrate larvae (e.g., barnacles and *Cancer* megalopae)


Trawl:

- Subadult, yearling, and subyearling salmon (primarily Chinook and Coho)
- Coastal pelagic species, such as Pacific sardine, Northern Anchovy, American Shad, various smelts, Jack Mackerel, and Pacific Herring. However, because sampling occurs during daylight hours, some forage species are not sampled well due to their diel vertical migrations.
