...
using namespace density;
  ...
  for( int i=0; i<z_i.size(); i++){
    ...
    jnll -= dbinom_robust(z_i(i), Type(1), beta_0 + beta_ov_ab*ov_ab_t_latent(t_i(i)), true ); // this is a Bernoulli (by using Type(1) as the size argument)
  }
