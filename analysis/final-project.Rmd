...
SST_sf_proj_km_2000 %>% 
  filter(dist_shore <= 100) -> grid_within_100km_shore
...
inland_waters <- st_as_sfc(st_bbox(c(xmin=-123.5, xmax=-121, ymin=44, ymax=48.5), crs = "WGS84"))
...
st_convex_hull(st_union(survey_domain)) -> survey_domain_polygon
...
csyis$sf_dist_shore <- csyis_dist_shore
# they're similar - but not identical
hist(as.numeric(csyis_test$sf_dist_shore)-csyis_test$km_from_shore)
...
Data = list( "D_i"= csyis$n_per_km, "t_i" = csyis$year - min(csyis$year), 
             "temp_i" = csyis$x3m_temp_c, "dist_i" = csyis$sf_dist_shore,
